        ...
        <div style="display: none;padding: 5px" id="addOrUpdateWindow">
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="dept_address" lay-verify="required" autocomplete="off" placeholder="请输入部门地址"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea class="layui-textarea" name="dept_remark" id="content"></textarea>
                    </div>
                </div>
...
<script>
    layui.use(['form', 'table','layer'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[
                {field: 'dept_id', width: 120, title: '部门编号', align: "center"},
                {field: 'dept_name', minWidth: 120, title: '部门名称', align: "center"},
                {field: 'dept_address', minWidth: 120, title: '部门地址', align: "center"},
                {field: 'dept_createDate', minWidth: 120, title: '创建时间', align: "center"},
                {field: 'dept_remark', minWidth: 100, title: '部门备注', align: "center"},
       ...
       //监听表单提交事件
         ...
         function deleteById(data) {
             //判断当前部门下是否存在员工
             $.get("/admin/dept/checkDeptHasEmployee",{"dept_id":data.dept_id},function(result){
                 ...
                 if(result.exist){
                     ...
                     //提示用户是否删除该部门
                     layer.confirm("确定要删除[<font color='red'>"+data.dept_name+"</font>]吗", {icon: 3, title:'提示'}, function(index){
                         //发送ajax请求进行删除
                         $.post("/admin/dept/deleteById",{"dept_id":data.dept_id},function(result){
                             if(result.success){
                                 //刷新数据表格
                                 tableIns.reload();
                             }
