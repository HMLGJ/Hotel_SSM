                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="floor_name" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
            ...
            <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="floor_name" lay-verify="required" autocomplete="off"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea class="layui-textarea" name="floor_remark" id="content"></textarea>
                    </div>
                </div>
    ...
    layui.use(['form', 'table', 'laydate', 'jquery','layer'], function () {
        ...
        var tableIns = table.render({
            ...
            cols: [[
                ...
                {field: 'floor_id', width: 100, title: '楼层编号', align: "center"},
                {field: 'floor_name', minWidth: 150, title: '楼层名称', align: "center"},
                {field: 'floor_remark', minWidth: 200, title: '备注', align: "center"},
        ...
        function deleteById(data) {
            //提示用户是否删除该楼层
            layer.confirm("确定要删除[<font color='red'>"+data.floor_name+"</font>]吗", {icon: 3, title:'提示'}, function(index){
                //发送ajax请求进行删除
                $.post("/admin/floor/deleteById",{"floor_id":data.floor_id},function(result){
                    if(result.success){
                        //刷新数据表格
                        tableIns.reload();
                    }
