                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline iphone">
                                <div class="layui-input-inline">
                                    ...
                                    <input type="text" name="user_name" id="mNickname" lay-verify="required" lay-reqText="请输入昵称"  placeholder="请输入昵称" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-inline iphone">
                                <div class="layui-input-inline">
                                    ...
                                    <!-- required|phone表示验证的格式为手机号码格式 -->
                                    <input type="tel" name="user_phone" id="user_phone" lay-verify="required|phone" lay-reqText="请输入手机号" placeholder="请输入手机号" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-inline iphone">
                                <div class="layui-input-inline">
                                    ...
                                    <input id="pnum" type="user_password" name="user_password" lay-verify="required" lay-reqText="请输入登录密码" placeholder="请输入登录密码" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
...
<script>
    layui.use(["form","element","carousel"], function () {
        ...
        $("#mNickname").blur(function () {
            //获取用户名
            var user_name = $("#mNickname").val().trim();
            //判断用户名是否为空，不为空则发送请求验证
            if(user_name.length>0){
                $.get("/user/checkName",{"user_name":user_name},function(result){
                    if(result.exist){
                    	//icon:5，不开心脸图标
