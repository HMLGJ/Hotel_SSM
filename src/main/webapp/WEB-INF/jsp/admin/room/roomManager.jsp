                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="room_roomnum" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">房间类型</label>
                            <div class="layui-input-inline">
                                <select name="room_roomtypeid" id="s_roomTypeId" autocomplete="off" class="layui-input">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="room_floorid" id="s_floorId" autocomplete="off" class="layui-input">
                                    <option value="">全部</option>
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="room_status" id="s_status" autocomplete="off" class="layui-input">
                                    <option value="">全部</option>
                ...
                <div class="layui-col-md12 layui-col-xs12">
                        ...
                        <div class="layui-col-md9 layui-col-xs7">
                            <div class="layui-form-item magt3" style="margin-top: 8px;">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="room_roomnum" lay-verify="required"  placeholder="请输入房间编号">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">房间类型</label>
                                <div class="layui-input-block">
                                    <select name="room_roomtypeid" id="room_roomtypeid" lay-verify="required">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea class="layui-textarea" name="room_remark" id="room_remark"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="layui-col-md3 layui-col-xs5">
                            <div class="layui-upload-list thumbBox mag0 magt3">
                                <input type="hidden" name="room_photo" id="room_photo" value="/statics/images/defaultimg.jpg">
                    ...
                    <div class="layui-form-item magb0">
                        <div class="layui-inline">
                            <label class="layui-form-label">所属楼层</label>
                            <div class="layui-input-inline">
                                <select name="room_floorid" id="room_floorid" lay-verify="required">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">房间状态</label>
                            <div class="layui-input-inline">
                                <select name="room_status" id="room_status" lay-verify="required">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" >
                            <textarea id="room_roomrequirement" name="room_roomrequirement" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">房间详情</label>
                        <div class="layui-input-block" >
                            <textarea id="room_roomdesc" name="room_roomdesc" style="display: none;"></textarea>
                        </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block" style="text-align: center;">
...
<script>
    layui.use(['form', 'table', 'laydate', 'jquery', 'layer','upload','layedit'], function () {
        ...
        var tableIns = table.render({
            ...
            toolbar: '#toolbarDemo',
            cols: [[
                {field: 'room_id', width: 60, title: '编号', align: "center"},
                {field: 'room_roomnum', minWidth: 120, title: '房间编号', align: "center"},
                {field: 'room_typeName', minWidth: 100, title: '房间类型', align: "center"},
                {field: 'room_floorName', minWidth: 100, title: '所属楼层', align: "center"},
                {field: 'room_statusStr', minWidth: 100, title: '房间状态', align: "center",templet:function (d){
                        if(d.room_status==1){
                            return "<font color='red'>已预定</font>";
                        }else if(d.room_status==2){
                            return "<font color='#33a3dc'>已入住</font>";
                        }else if(d.room_status==3){
        ...
        $.get("/admin/roomType/findAll",function(result){
            ...
            //将网页代码追加到下拉列表中
            $("[name='room_roomtypeid']").append(html);
            //重新渲染下拉列表
            form.render("select");
        },"json");
        ...
        $.get("/admin/floor/findAll",function(result){
            var html = "";
            for (var i = 0; i < result.length; i++) {
                html +="<option value='"+result[i].floor_id+"'>"+result[i].floor_name+"</option>"
            }
            //将网页代码追加到下拉列表中
            $("[name='room_floorid']").append(html);
            //重新渲染下拉列表
            form.render("select");
        },"json");
        ...
        upload.render({
            elem:".thumbImg",//绑定元素
            //本来是/admin/roomType/uploadFile，但我重新写了一个专门负责文件图片上传的file的Controller
        ...
        function openAddWindow() {
            mainIndex = layer.open({
                ...
                maxmin: true,//窗口显示最大最小化,在layui文档的弹出层中的最大化
                ...
                success: function () {
                    ...
                    //重置图片隐藏域的值
                    $("#room_photo").val("images/defaultimg.jpg");
                }
            });
            ...
            //初始化富文本编辑器，layui帮助文档中的内置模块的富文本编辑器
            detailIndex = layedit.build("room_roomdesc",{
                uploadImage:{
                    url:"/admin/file/uploadFile",//文件上传地址
                    type:"post"//提交方式
                }
        ...
        function openUpdateWindow(data) {
            mainIndex = layer.open({
                ...
                success: function () {
                    ...
                    //图片回显
                    $(".thumbImg").attr("src","/hotel/show/"+data.room_photo);
                    //图片隐藏域的值回显
                    $("#room_photo").val(data.room_photo);
                }
            });
            //设置窗口打开时最大化显示
            layer.full(mainIndex);
        ...
        form.on("submit(doSubmit)",function (data) {
            ...
            //将富文本编辑器的内容同步到文本域textarea中,不加的话，富文本内容存不到数据库。
            layedit.sync(detailIndex);////富文本编辑器的索引,目前在第304代码行
            
            //$("#dataFrm").serialize()：序列化获取，一次性获取表单的数据，要求表单标签必须有name属性值
        ...
        function deleteById(data) {
            ...
            if(data.room_status==3){
                //提示是否删除
                //提示用户是否删除该房间
                layer.confirm("确定要删除[<font color='red'>"+data.room_roomnum+"</font>]房间吗？", {icon: 3, title:'提示'}, function(index){
                    //发送ajax请求进行删除
                    $.post("/admin/room/deleteById",{"room_id":data.room_id},function(result){
                        if(result.success){
                            //刷新数据表格
                            tableIns.reload();
                        }
                ...
                layer.msg("只能删除状态为[<font color='#green'>可预订</font>]的房间！");
            }
        }
