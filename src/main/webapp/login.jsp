        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
           ...
           <li data-id="room" class="layui-nav-item layui-hide-xs">
            ...
            <li data-id="login" class="layui-nav-item layui-hide-xs layui-this">
                <a class="fly-case-active" data-type="toTopNav" href="/login.jsp">登录</a></li>
            <li data-id="register" class="layui-nav-item layui-hide-xs ">
                <a class="fly-case-active" data-type="toTopNav" href="/register.jsp">注册</a></li>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline iphone">
                                    <div class="layui-input-inline">
                                        ...
                                        <input type="tel" name="user_name" id="user_name" lay-verify="required" lay-reqText="请输入登录用户名" placeholder="请输入登录用户名" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-inline iphone">
                                    <div class="layui-input-inline">
