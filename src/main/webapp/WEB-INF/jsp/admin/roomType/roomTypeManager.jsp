                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="roomType_name" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-col-md12 layui-col-xs12">
                        ...
                        <div class="layui-col-md9 layui-col-xs7">
                            <div class="layui-form-item magt3" style="margin-top: 8px;">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="roomType_name" lay-verify="required"  placeholder="请输入房型名称">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">房型状态</label>
                                <div class="layui-input-block">
                                    <select name="roomType_status" id="roomType_status" lay-verify="required">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea class="layui-textarea" name="roomType_remark" id="roomType_remark"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="layui-col-md3 layui-col-xs5">
                            <div class="layui-upload-list thumbBox mag0 magt3">
                                <input type="hidden" name="roomType_photo" id="roomType_photo" value="images/defaultimg.jpg">
                    ...
                    <div class="layui-form-item magb0">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="roomType_price" lay-verify="required|number"
                                       placeholder="请输入参考价格">
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="roomType_livenum" lay-verify="required|number"
                                       placeholder="请输入可住人数">
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="roomType_bednum" lay-verify="required|number" placeholder="请输入床位数">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">房间数</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="roomType_roomnum" lay-verify="required|number"
                                       placeholder="请输入房间数">
                            </div>
                        </div>
                    </div>
...
<script>
    layui.use(['form', 'table', 'laydate', 'jquery', 'layer','upload'], function () {
        ...
        var tableIns = table.render({
            ...
            toolbar: '#toolbarDemo',
            cols: [[
                {field: 'roomType_id', width: 60, title: '编号', align: "center"},
                {field: 'roomType_name', minWidth: 150, title: '名称', align: "center"},
                {field: 'roomType_price', minWidth: 100, title: '价格', align: "center"},
                {field: 'roomType_livenum', minWidth: 100, title: '可住人数', align: "center"},
                {field: 'roomType_bednum', minWidth: 100, title: '床位数', align: "center"},
                {field: 'roomType_roomnum', minWidth: 100, title: '房间数', align: "center"},
                {field: 'roomType_avilablenum', minWidth: 100, title: '可用房间数', align: "center"},
                {field: 'roomType_reservednum', minWidth: 100, title: '已预订数', align: "center"},
                {field: 'roomType_livednum', minWidth: 100, title: '已入住数', align: "center"},
                //状态目前是写死了的，到时候要改，在实体类里做判断。
                {field: 'roomType_status', minWidth: 100, title: '状态', align: "center",templet:function (data) {
                        return data.roomType_status == 1 ? "<font color='green'>可预订</font>" : "<font color='red'>房型已满</font>"
                    }},
                {field: 'roomType_remark', minWidth: 100, title: '备注', align: "center"},
        ...
        function openAddWindow() {
            mainIndex = layer.open({
                ...
                success: function () {
                    ...
                    //我自己在文件夹定义了一个路径/statics/images/defaultimg.jpg
                    $(".thumbImg").attr("src","/hotel/show/images/defaultimg.jpg");
                    
                    //重置图片隐藏域的值
                    $("#roomType_photo").val("images/defaultimg.jpg");
                }
            });
        }
        /**
        ...
        function openUpdateWindow(data) {
            mainIndex = layer.open({
                ...
                success: function () {
                    ...
                    //图片回显
                    $(".thumbImg").attr("src","/hotel/show/"+data.roomType_photo);
                    //图片隐藏域的值回显
                    $("#roomType_photo").val(data.roomType_photo);
                }
            });
        }
        ...
        upload.render({
            ...
            //文件上传成功后的回调函数
                ...
                //给图片隐藏域赋值
                $("#roomType_photo").val(res.imagePath);
            }
        });
        ...
        function deleteById(data) {
            ...
            if(data.roomType_status==1){
                //提示是否删除
                //提示用户是否删除该房间
                layer.confirm("确定要删除[<font color='red'>"+data.roomType_name+"</font>]房型吗？", {icon: 1, title:'提示'}, function(index){
                    //发送ajax请求进行删除
                    $.post("/admin/roomType/deleteById",{"roomType_id":data.roomType_id},
                        function(result){
                            if(result.success){
                                //刷新数据表格
                                tableIns.reload();
